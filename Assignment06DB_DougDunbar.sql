...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_DougDunbar')
	 Begin 
	  Alter Database [Assignment06DB_DougDunbar] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_DougDunbar;
	 End
	Create Database Assignment06DB_DougDunbar;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_DougDunbar;
...
Select Top 1000000 
 ...
 dbo.vProducts as P ON
  C.CategoryID = P.CategoryID
 Join dbo.vInventories as I ON
  I.ProductID = P.ProductID
 Join dbo.vEmployees as E ON
  E.EmployeeID = I.EmployeeID
 Join dbo.vEmployees as M ON
  E.ManagerID = M.ManagerID
 Order By 2,4,6,10;
GO
